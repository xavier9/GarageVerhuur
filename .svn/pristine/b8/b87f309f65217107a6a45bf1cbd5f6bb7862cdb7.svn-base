...
import com.ehb.xavier.garageverhuur.GarageActions.GarageDetailActivity;
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (Utils.hasHoneycomb()) {
                ...
                vmPolicyBuilder
                        .setClassInstanceLimit(GarageGetActivity.class, 1)
                        .setClassInstanceLimit(GarageDetailActivity.class, 1);
            }
